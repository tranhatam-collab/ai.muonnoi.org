-- Patch: run only CREATE TABLE IF NOT EXISTS portions of 0004_social_core.sql
-- Skips ALTER TABLE users ADD COLUMN (columns already exist from prior partial run)
...
VALUES
  ...
  ('content', 'Content', 'Published content from editorial pipeline', unixepoch()*1000);
